...
export async function extractDocument(input, ctx) {
  ...
  const mergedSettings = {
    ...
    deferSave: _deferSave === true,
    outputStem: typeof _outputStem === "string" && _outputStem ? _outputStem : null,
    mediaPrefix: typeof _mediaPrefix === "string" ? _mediaPrefix : "",
  };
  ...
  if (mergedSettings.deferSave) args.push("--defer-save");
  if (mergedSettings.outputStem) args.push("--output-stem", mergedSettings.outputStem);
  if (mergedSettings.mediaPrefix) args.push("--media-prefix", mergedSettings.mediaPrefix);
